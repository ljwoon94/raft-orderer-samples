...
function generateCerts() {
  ...
  echo
  echo "Generate CCP files for Org1 and Org2 and Org3 and Org4 and Org5"
  ./ccp-generate.sh
  ...
  mv crypto-config/peerOrganizations/org4.example.com/ca/*_sk crypto-config/peerOrganizations/org4.example.com/ca/ca.org4.example.com_sk
  mv crypto-config/peerOrganizations/org5.example.com/ca/*_sk crypto-config/peerOrganizations/org5.example.com/ca/ca.org5.example.com_sk
}
